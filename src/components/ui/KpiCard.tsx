...
export function KpiCard({
  ...
  return (
    ...
    >
      <div
        className={`h-full relative overflow-hidden rounded-2xl border-l-4 ${a.border} bg-white border border-gray-200 shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 dark:border-border dark:bg-card`}
      >
        ...
        <div className="relative p-5 flex flex-col h-full">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex shrink-0 flex-col items-end gap-1">
              ...
              {manageHref && (
                <Button variant="ghost" size="sm" asChild className="text-xs h-7 -mr-1">
